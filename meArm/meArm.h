...
class meArm {
  public:
    ...
    meArm(int sweepMinBase=145, int sweepMaxBase=49, float angleMinBase=-pi/4, float angleMaxBase=pi/4,
      ...
      int sweepMinGripper=144, int sweepMaxGripper=36, float angleMinGripper=pi/4, float angleMaxGripper=-pi/4);
    ...
    void Garra(float angle);                       // acepts a radian angle betwee 0 and pi/2
